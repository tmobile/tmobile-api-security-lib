...
//			this.logger = new Mock<ILogger<Encryption>>();
		...
		public async Task EncryptAsync_RSA_Success()
		{
			...
			var publicEncryption = new Encryption(this.publicRSAKeyResolver.Object);  //, null); // this.logger.Object);
			var privateEncryption = new Encryption(this.privateRSAKeyResolver.Object);  //, null); // this.logger.Object);
		...
		public async Task EncryptAsync_EC_Success()
		{
			// Arrange
			string expectedValue = "Test data!";
			var publicEncryption = new Encryption(this.publicECKeyResolver.Object);  //, null); // this.logger.Object);
			var privateEncryption = new Encryption(this.privateECKeyResolver.Object);  //, null); // this.logger.Object);
		...
		public async Task EncryptAsync_InvalidEncryptionData_Throws()
		{
			...
			publicRSAKeyResolver.Setup(k => k.GetEncryptionKeyAsync())
											 .ReturnsAsync(() => rsaPublicJsonWebKey);
			var publicEncryption = new Encryption(publicRSAKeyResolver.Object);  //, null); // this.logger.Object);
		...
		public async Task EncryptAsync_PublicKeyNotFound_Throws()
		{
			...
			var publicEncryption = new Encryption(this.publicOctKeyResolver.Object);  //, null); // this.logger.Object);
		...
		public async Task EncryptAsync_NoPublicKeysFound_Throws()
		{
			// Arrange
			string expectedValue = "Test data!";
			var publicEncryption = new Encryption(this.publicNullKeyResolver.Object);  //, null); // this.logger.Object);
		...
		public async Task DecryptAsync_UnsupportJsonWebKeyType_Throws()
		{
			...
			var cipher = Constants.CIPHER_HEADER + Jose.Base64Url.Encode(Encoding.UTF8.GetBytes(cipherJson));
			var publicEncryption = new Encryption(this.privateOctKeyResolver.Object);  //, null); // this.logger.Object);
