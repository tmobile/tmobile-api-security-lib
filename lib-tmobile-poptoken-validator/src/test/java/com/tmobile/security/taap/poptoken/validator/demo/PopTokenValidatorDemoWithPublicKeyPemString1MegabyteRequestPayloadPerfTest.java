...
public class PopTokenValidatorDemoWithPublicKeyPemString1MegabyteRequestPayloadPerfTest {

    private static final Logger logger = LoggerFactory.getLogger(PopTokenValidatorDemoWithPublicKeyPemString1MegabyteRequestPayloadPerfTest.class);
    ...
    public void validatePopTokenWithPublicKeyPemString() throws Exception {
        ...
        logger.info(
                "PopTokenValidatorDemoWithPublicKeyPemString1MegabytePerfTest -> actual processing time: " + processingTime + " ms"); //
        assertTrue("Should not have taken more than 20 seconds for 1000 validations, actual processing time: " + processingTime,
