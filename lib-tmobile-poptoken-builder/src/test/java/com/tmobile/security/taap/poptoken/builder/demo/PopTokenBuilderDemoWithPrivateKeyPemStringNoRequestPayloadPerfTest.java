...
public class PopTokenBuilderDemoWithPrivateKeyPemStringNoRequestPayloadPerfTest {

    private static final Logger logger = LoggerFactory
            .getLogger(PopTokenBuilderDemoWithPrivateKeyPemStringNoRequestPayloadPerfTest.class);
