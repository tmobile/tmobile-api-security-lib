...
public class PopTokenValidatorDemoWithPublicKeyPemString1KilobyteRequestPayloadPerfTest {

    private static final Logger logger = LoggerFactory.getLogger(PopTokenValidatorDemoWithPublicKeyPemString1KilobyteRequestPayloadPerfTest.class);

    private static final int NUM_BYTES_IN_ONE_KILOBYTE = 1 * 1024;
    private static final String ONE_KILOBYTE_REQUEST_PAYLOAD = PopTokenValidatorTestHelper
    ...
    public void validatePopTokenWithPublicKeyPemString() throws Exception {
        ...
        logger.info(
                "PopTokenValidatorDemoWithPublicKeyPemString1KilobytePerfTest -> actual processing time: " + processingTime + " ms"); //
    ...
    private String getEhtsValue(String ehtsKey) {
        ...
        if (ehtsKey.equals("content-type")) {
            ...
            return ONE_KILOBYTE_REQUEST_PAYLOAD;
        } else {
            return null;
        }
    }
