...
public class PopTokenValidatorDemoWithPublicKeyPemString10KilobyteRequestPayloadPerfTest {

    private static final Logger logger = LoggerFactory.getLogger(PopTokenValidatorDemoWithPublicKeyPemString10KilobyteRequestPayloadPerfTest.class);

    private static final int NUM_BYTES_IN_TEN_KILOBYTE = 10 * 1024;
    private static final String TEN_KILOBYTE_REQUEST_PAYLOAD = PopTokenValidatorTestHelper
            .createRequestPayload(NUM_BYTES_IN_TEN_KILOBYTE);
    ...
    public void validatePopTokenWithPublicKeyPemString() throws Exception {
        ...
        logger.info(
                "PopTokenValidatorDemoWithPublicKeyPemString10KilobytePerfTest -> actual processing time: " + processingTime + " ms"); //
        assertTrue("Should not have taken more than 5 seconds for 1000 validations, actual processing time: " + processingTime,
                (processingTime < 5000)); //
    }
    ...
    private String getEhtsValue(String ehtsKey) {
        ...
        if (ehtsKey.equals("content-type")) {
            ...
            return TEN_KILOBYTE_REQUEST_PAYLOAD;
        } else {
            return null;
        }
    }
