...
import com.tmobile.security.taap.poptoken.builder.testutils.PopTokenBuilderTestUtils;

public class PopTokenBuilderDemoWithPrivateKeyPemString10KilobyteRequestPayloadPerfTest {

    private static final Logger logger = LoggerFactory
            .getLogger(PopTokenBuilderDemoWithPrivateKeyPemString10KilobyteRequestPayloadPerfTest.class);

    private static final int NUM_BYTES_IN_TEN_KILOBYTE = 10 * 1024;
    private static final String TEN_KILOBYTE_REQUEST_PAYLOAD = PopTokenBuilderTestUtils.createRequestPayload(NUM_BYTES_IN_TEN_KILOBYTE);
    ...
    public void buildPopTokenWithPrivateKeyPemString() throws PopTokenBuilderException {
        ...
        logger.info("PopTokenBuilderDemoWithPrivateKeyPemString10KilobytePayloadPerfTest -> actual processing time: "
                + (endTime - startTime) + " ms");
        assertTrue("Actual processing time is " + (endTime - startTime) + " ms", (endTime - startTime) <= 30000);
    }
    ...
    private void buildPopTokenWithPrivateKeyPemString(String privateKeyPemString) throws PopTokenBuilderException {
        ...
        ehtsKeyValueMap.put(PopEhtsKey.BODY.keyName(), TEN_KILOBYTE_REQUEST_PAYLOAD);
