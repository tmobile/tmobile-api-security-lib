...
For more information on PoP token builder library, please refer to the readme file - [PoP Token Builder Library Readme.md](./tmobile-poptoken-builder/readme.md).
...
For more information on PoP token validator library, please refer to the readme file - [PoP Token Validator Library Readme.md](./tmobile-poptoken-builder/readme.md).
