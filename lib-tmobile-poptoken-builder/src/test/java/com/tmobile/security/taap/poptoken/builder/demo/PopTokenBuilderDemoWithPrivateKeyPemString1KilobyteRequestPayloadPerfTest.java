...
public class PopTokenBuilderDemoWithPrivateKeyPemString1KilobyteRequestPayloadPerfTest {
    ...
    private static final String ONE_KILOBYTE_REQUEST_PAYLOAD = PopTokenBuilderTestUtils.createRequestPayload(NUM_BYTES_IN_ONE_KILOBYTE);
    ...
    public void buildPopTokenWithPrivateKeyPemString() throws PopTokenBuilderException {
        ...
        logger.info("PopTokenBuilderDemoWithPrivateKeyPemString1KilobytePayloadPerfTest -> actual processing time: " + (endTime - startTime) + " ms");
        assertTrue("Actual processing time is " + (endTime - startTime) + " ms", (endTime - startTime) <= 20000);
    }
