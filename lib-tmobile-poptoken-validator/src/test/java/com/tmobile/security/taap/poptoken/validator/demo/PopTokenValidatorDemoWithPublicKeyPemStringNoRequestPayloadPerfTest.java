...
public class PopTokenValidatorDemoWithPublicKeyPemStringNoRequestPayloadPerfTest {

    private static final Logger logger = LoggerFactory.getLogger(PopTokenValidatorDemoWithPublicKeyPemStringNoRequestPayloadPerfTest.class);
    ...
    public void validatePopTokenWithPublicKeyPemString() {
        ...
        logger.info(
                "PopTokenValidatorDemoWithPublicKeyPemStringNoRequestPayloadPerfTest -> actual processing time: " + processingTime + " ms"); //
        assertTrue("Should not have taken more than 10 seconds for 1000 validations, actual processing time: " + processingTime,
                (processingTime < 10000));
    }

    private void doValidate(String popToken, String publicKeyPemString) {
        try {
